...
//                 <div className="w-3 h-3 rounded-full border-2 border-white absolute -right-1 -bottom-1 z-10" style={{ backgroundColor: getStatusColor() }}></div>
//                 <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center text-gray-600">
//                   {username.charAt(0).toUpperCase()}
//                 </div>
//               </div>
//               <svg
//                 className={`ml-1 h-5 w-5 text-gray-400 transition-transform duration-200 ${dropdownOpen ? "transform rotate-180" : ""}`}
