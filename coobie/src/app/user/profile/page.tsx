...
//   } catch (error: unknown) {
//     console.error(`사용자 조회 중 오류 발생 (ID: ${context.params.id}):`, error);
//     return NextResponse.json(
//       {
//         error:
...
//   } catch (error: unknown) {
//     console.error(`사용자 업데이트 중 오류 발생 (ID: ${context.params.id}):`, error);
//     return NextResponse.json(
//       {
...
//     });
//   } catch (error: unknown) {
//     console.error(`사용자 삭제 중 오류 발생 (ID: ${context.params.id}):`, error);
//     return NextResponse.json(
